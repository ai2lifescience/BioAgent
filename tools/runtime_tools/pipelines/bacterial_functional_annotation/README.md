...
`BioAgent/pipelines/bacterial_functional_annotation/` and ensure that the Conda environment named
...
In BioAgent, provide `pipeline_name: bacterial_functional_annotation` and `input_data`. The required
