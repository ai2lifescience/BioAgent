...
`BioAgent/pipelines/bacterial_virulence_factor_detection/` and ensure that the Conda environment named
...
In BioAgent, use `pipeline_name: bacterial_virulence_factor_detection` and `input_data`. The required
