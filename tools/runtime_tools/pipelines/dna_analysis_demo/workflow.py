...
def fail(message: str) -> None:
    raise SystemExit(f"dna_analysis_demo: {message}")
...
def write_vcf(
    ...
    with path.open("w", encoding="utf-8", newline="") as handle:
        ...
        handle.write("##source=dna_analysis_demo_positional_comparison\n")
...
def main(argv: list[str]) -> int:
    ...
    label = str(config.get("label") or "dna_analysis_demo")
