...
`BioAgent/pipelines/antimicrobial_resistance_detection/` and ensure that the Conda environment named
...
In BioAgent, provide `pipeline_name: antimicrobial_resistance_detection` and `input_data`. Use
