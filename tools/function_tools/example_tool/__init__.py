...
Use only for testing tool calling, registry wiring, or the example tool. Do
...
from .workflow import example_tool as _workflow
...
async def example_tool(
    ...
    return await run_workflow(ctx.context, 'example_tool', _workflow,
        {'message': message, 'tag': tag, 'uppercase': uppercase}, category='example_tool',
        with_progress=False)
