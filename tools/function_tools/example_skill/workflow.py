...
from tools.function_tools.example_skill.diagnostics import echo_tool as _action_echo
from typing import Any
from tools.common.context import WorkflowContext, ensure_workflow_context

def example_skill(message: str, tag: str | None=None, uppercase: bool=False, context: WorkflowContext | None=None) -> dict[str, Any]:
