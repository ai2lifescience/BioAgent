...
from tools.function_tools.pipeline_runner.engine.inputs import pipeline_input_specs, stringify_input_value
from tools.function_tools.pipeline_runner.engine.outputs import finalize_output_records
...
from tools.function_tools.pipeline_runner.engine.wdl_options import write_options_runtime_json
...
def run_wdl_pipeline(
    ...
    if selected_engine == "cromwell" and not dry_run:
        from tools.function_tools.pipeline_runner.engine.cromwell import run_cromwell_pipeline
