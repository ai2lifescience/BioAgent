...
from biology.pipeline_runner.inputs import pipeline_input_specs, stringify_input_value
from biology.pipeline_runner.outputs import finalize_output_records
...
from biology.pipeline_runner.wdl_options import write_options_runtime_json
...
def run_wdl_pipeline(
    ...
    if selected_engine == "cromwell" and not dry_run:
        from biology.pipeline_runner.cromwell import run_cromwell_pipeline
