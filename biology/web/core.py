...
from biology.web.constants import TRUSTED_WEB_DOMAINS
from biology.web.fetch import fetch_trusted_web_page
from biology.web.search import duckduckgo_search
