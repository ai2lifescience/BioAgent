...
from biology.pipeline_results.core import collect_pipeline_results as _action_pipeline_results_collect
...
def pipeline_results(pipeline_name: str='', max_table_rows: int=10, context: WorkflowContext | None=None) -> dict[str, Any]:
    ...
    result = context.call('pipeline_results_collect', _action_pipeline_results_collect, {'artifacts': context.artifacts, 'collection_dir': context.artifact_path('pipeline-results', context.run_id or 'latest'), 'pipeline_name': pipeline_name, 'max_table_rows': max_table_rows})['result']
